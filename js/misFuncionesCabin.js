function autoInicioCategoria(){
    ...
    $.ajax({
        url:"http://168.138.132.137:9090/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function traerInformacionSkate() {
    $.ajax({
        url:"http://168.138.132.137:9090/api/Cabin/all",
        //url: "http://localhost:9090/api/Cabin/all",
        type: "GET",
        datatype: "JSON",
...
function cargarDatosSkate(id) {
    $.ajax({
        dataType: 'json',
        url:"http://168.138.132.137:9090/api/Cabin/"+id,
        //url: "http://localhost:9090/api/Cabin/" + id,
        type: 'GET',
   ...
   // if($("#name").val().length == 0 || $("#brand").val().length == 0 || $("#rooms").val().length == 0 || $("#description").val().length == 0){
    ...
    //}else{
            ...
            $.ajax({
                ...
                url:"http://168.138.132.137:9090/api/Cabin/save",
                //url: "http://localhost:9090/api/Cabin/save",
                data: dataToSend,
                datatype: 'json',
    ...
    $.ajax(
        {
            dataType: 'json',
            data: dataToSend,
            url:"http://168.138.132.137:9090/api/Cabin/"+idElemento,
            //url: "http://localhost:9090/api/Cabin/" + idElemento,
            type: 'DELETE',
            contentType: "application/JSON",
            success: function (response) {
                console.log(response);
...
function actualizar(idElemento) {
    ...
    if($("#name").val().length == 0 || $("#brand").val().length == 0 || $("#rooms").val().length == 0 || $("#description").val().length == 0){
        ...
        $.ajax({
            ...
            data: dataToSend,
            contentType: "application/JSON",
            url:"http://168.138.132.137:9090/api/Cabin/update",
           // url: "http://localhost:9090/api/Cabin/update",
            type: "PUT",
